...
# Fecha: $timestamp
# Último cambio: Creado para declarar todos los assets de iconos del firmware.
# Descripción: Este fichero de cabecera centraliza las declaraciones de todas las imágenes de los botones que se compilan en el firmware. Permite que `ui_asset_loader.c` acceda a ellas de forma segura.
*/
