 ...
 * Fecha: 08/08/2025 - 06:45
 * Último cambio: Restaurado a la versión con rotación a nivel de driver.
 * Descripción: Driver del display. Esta es la versión que funciona y muestra la imagen y colores correctamente. Rota el panel a nivel de hardware para presentar una pantalla de 170x320. Este archivo es la versión final y no se volverá a tocar.
 */
#include "bsp_api.h"
#include "esp_log.h"
...
esp_err_t bsp_display_init(void) {
    ...
    spi_bus_config_t buscfg = {
        ...
        .miso_io_num = PIN_NUM_SD_MISO, .max_transfer_sz = BSP_LCD_H_RES * 100 * sizeof(uint16_t)
    };
    ...
    // --- Esta es la rotación correcta para el display ---
